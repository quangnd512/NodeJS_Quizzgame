...
| Mục | Giá trị |
|-----|---------|
| Tính năng | Feature 017 — Mobile Stage 1 (màn hình học tập mobile) |
| Branch | feature/mobile-stage1 |
| Bắt đầu từ | 2026-09-05 |
...
|---------|-----|------------|--------------|---------------|
| S1 | Kiến Trúc Sư | ✅ Done (12 TASK, DoD: 12 task + API contract + test PASS) | — | 0 |
| S2 | Thợ Code | ✅ Done (fix 3 bug: typecheck + Battle display + NaN guard) | — | 1 |
| S3 | Người Soát Lỗi | ✅ Done (1 lỗi socket listener fixed, 66/66 PASS) | — | 0 |
| S4 | Người Ghi Chép | ✅ Done (FEATURE_LOG, CHANGELOG, user-guide, TEST_CASES) | — | 0 |
| S5 | Người Thử Nghiệm | ✅ Done (22 test cases: 6 PASS, 2 PARTIAL, 2 FAIL, 12 SKIP) | — | 0 |
| S6 | Người Giảng Giải | ⏭ Bỏ qua | — | — |
| S7 | Người Đóng Gói | ⏸ Chờ lệnh | Push & merge feature/mobile-stage1 (sau khi S8 PASS) | 0 |
| S8 | Giám Sát Chất Lượng | ✅ Done (Feature 017 ĐẠT — 10/10 tiêu chí, 66/66 PASS, 0 typecheck error) | — | — |
