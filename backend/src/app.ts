...
const ERROR_CODE_TO_HTTP_STATUS: Readonly<Record<string, number>> = {
  ...
  REPORT_RESUBMIT_CONFIRM_REQUIRED: 409,
  QUESTION_REPORT_NOT_FOUND: 404,
  REPORT_NOT_PENDING: 409,
  // Free/Premium Framework
  INVALID_PREMIUM_MONTHS: 400,
  WRONG_ANSWER_REVIEW_PREMIUM_ONLY: 403,
  EXAM_HISTORY_PREMIUM_ONLY: 403,
  SUBJECTS_CHANGE_LOCKED: 403,
  PREMIUM_USER_NOT_FOUND: 404,
  PREMIUM_GRANT_CONFLICT: 409,
  // Avatar
