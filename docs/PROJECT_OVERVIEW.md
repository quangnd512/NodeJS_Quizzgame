...
| Progress Dashboard – Tiến độ học tập | Tổng quan (phiên ôn, lần thi, điểm, streak 🐝); so sánh tháng; thống kê theo môn + xu hướng điểm (Premium-only, Free nhận mảng rỗng); lịch sử thi thử phân trang (Premium-only, chặn 403 ở backend cho Free); 9 query song song (Promise.all) | ✅ Done |
| Ôn câu sai (Wrong Answer Review) | Xem lại và làm lại câu sai từ phiên Ôn tập và Thi thử; TTL 14 ngày; 3 loại câu (MCQ_4, TRUE_FALSE_4, FILL_BLANK); **Premium-only** (Free bị chặn 403 kể cả gọi thẳng API) | ✅ Done |
| Admin User Management + Dashboard | Tab Dashboard (6 chỉ số: tổng user, mới tuần/tháng, tổng phiên thi, tỷ lệ đậu, online ngay); Tab Người dùng (tìm kiếm/lọc/phân trang, chi tiết user + stats, khoá/mở khoá, reset mật khẩu, đổi role, xóa tài khoản, **cấp Premium theo tháng**) | ✅ Done |
...
| Khung Free/Premium | Công tắc toàn cục "Mặc định Premium cho tất cả" (mặc định BẬT, cache invalidate-on-write); admin cấp Premium theo tháng (cộng dồn/reset đúng quy tắc); 4 quyền lợi Premium (Ôn câu sai, Lịch sử thi thử + 2 mục thống kê Tiến độ, đổi môn không cần xem quảng cáo, 3 thẻ bảo hiểm chuỗi streak); đổi môn của Free qua bước "xem quảng cáo" giả lập + ad-unlock Redis TTL 300s single-use; cron cảnh báo Premium sắp hết hạn | ✅ Done |
| Thi đấu đối kháng — PvP Quiz Battle (ĐỢT 1/MVP) | Kết nối realtime ĐẦU TIÊN của dự án (Socket.io namespace `/battle`); cược điểm (50/100/200/500đ, chung mọi user ở đợt này), ghép trận nới lỏng tiêu chí 10s/20s/30s, bot fallback sau 30s (danh tính ẩn hoàn toàn — tên giả deterministic, không ai phân biệt được), mời bạn qua mã phòng 6 ký tự, 10 câu/trận chấm điểm theo thời gian SERVER, escrow cược (khoá lúc bắt đầu, chia lại lúc kết thúc), xử thắng kỹ thuật khi mất kết nối quá 30s (có pause/resume timer câu hỏi), tự động vào lại trận đang dở sau F5/đăng nhập lại (`GET /api/battle/active`), chặn 1 user vào 2 trận cùng lúc. Xem chi tiết luật chơi ở `docs/GAMEPLAY.md`. ĐỢT 2 (ELO, mùa giải, danh hiệu, phân biệt Free/Premium) CHƯA làm. | ✅ Done |
