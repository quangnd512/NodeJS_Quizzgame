...
> ⚠️ **Từ Feature 015 (Free/Premium)**: tài khoản **Free** phải "xem quảng
> cáo" giả lập trước mỗi lần đổi môn (xem mục "Free/Premium — Quyền lợi tài
> khoản" cuối tài liệu này). Tài khoản **Premium** đổi môn thoải mái, không
> cần bước này.
...
**Free — lỗi 403 nếu chưa mở khoá:**
```json
{
  "error": "SUBJECTS_CHANGE_LOCKED",
  "message": "Ban can xem quang cao de mo khoa doi mon hoc (goi POST /api/users/subjects/ad-unlock truoc)."
}
```
Gọi `POST /api/users/subjects/ad-unlock` trước (sau khi "xem" xong quảng cáo giả lập trên app) để mở khoá 1 lượt đổi môn (có hiệu lực 5 phút, dùng 1 lần).
...
> Streak chỉ về 0 khi cách ngày ôn gần nhất **hơn 2 ngày** — trừ khi bạn là
> **Premium** và còn "thẻ bảo hiểm chuỗi" (xem mục "Free/Premium — Quyền lợi
> tài khoản" cuối tài liệu này).

> ⭐ **Premium**: dưới số streak, bạn còn thấy dòng **"🛡️ Thẻ bảo hiểm chuỗi:
> X/3"** — mỗi thẻ tự động "cứu" 1 lần bạn lỡ quên ôn tập đúng 1 ngày mà
> không làm mất streak. Tài khoản Free không có thẻ nào.
...
> ⭐ **Chỉ dành cho Premium** (từ Feature 015). Tài khoản Free sẽ thấy banner
> "Lịch sử thi thử là quyền lợi Premium" thay vì bảng dữ liệu — xem mục
> "Free/Premium — Quyền lợi tài khoản" cuối tài liệu này. Các phần khác của
> trang Tiến độ (streak, điểm, thống kê theo môn...) vẫn hoạt động bình
> thường cho Free.

Với Premium, bảng lịch sử hiển thị tất cả lần bạn đã thi thử với:
...
trừ khi bạn là Premium và còn thẻ bảo hiểm chuỗi (bảo vệ đúng 1 lần lỡ 1 ngày).
...
> ⭐ **Chỉ dành cho Premium** (từ Feature 015). Tài khoản Free bấm vào tính
> năng này sẽ thấy banner "Ôn lại câu sai là quyền lợi Premium" thay vì danh
> sách câu sai — xem mục "Free/Premium — Quyền lợi tài khoản" cuối tài liệu
> này.
...
| ⭐ **Được cấp Premium** | Admin vừa cấp Premium cho tài khoản của bạn (theo tháng) — xem mục "Free/Premium — Quyền lợi tài khoản" |
| ⏰ **Premium sắp hết hạn** | Premium của bạn sẽ hết hạn trong 24 giờ tới — xem mục "Free/Premium — Quyền lợi tài khoản" |
...
| ⭐ **Được cấp Premium** / ⏰ **Premium sắp hết hạn** | Đánh dấu đã đọc + chuyển sang **Trang Tiến độ học tập** (nơi hiển thị hạn Premium và thẻ bảo hiểm chuỗi) |
...
## Free/Premium — Quyền lợi tài khoản (Feature 015)

QuizzGame có 2 loại tài khoản: **Free** (miễn phí) và **Premium**. Một số
tính năng chỉ dành cho Premium, hoặc Free phải làm thêm 1 bước nhỏ để dùng.

> 💡 Trong giai đoạn hiện tại, admin có thể bật công tắc "Mặc định Premium
> cho tất cả" — nếu công tắc này đang BẬT, **mọi tài khoản đều là Premium**
> miễn phí, kể cả khi chưa từng được cấp riêng. Nếu bạn thấy mình là Premium
> mà không nhớ đã được cấp, đây là lý do phổ biến nhất.

### So sánh Free vs Premium

| Tính năng | Free | Premium |
|-----------|------|---------|
| Ôn tập, Thi thử, Bảng xếp hạng, Đóng góp câu hỏi | ✅ Dùng đầy đủ | ✅ Dùng đầy đủ |
| **Đổi môn học** | Phải xem 1 "quảng cáo" ngắn (5 giây) mỗi lần đổi | Đổi thoải mái, không giới hạn |
| **Ôn lại câu sai** | ❌ Không dùng được | ✅ Dùng đầy đủ |
| **Lịch sử thi thử** (trang Tiến độ) | ❌ Không xem được | ✅ Xem đầy đủ |
| **Thẻ bảo hiểm chuỗi** (Streak Freeze) | Không có | 3 thẻ — mỗi thẻ tự "cứu" 1 lần lỡ quên ôn tập đúng 1 ngày |

### Cách biết mình đang Free hay Premium

- Ở Trang cá nhân, nếu bạn là Premium, tên bạn sẽ có huy hiệu **⭐ Premium**
  ngay bên cạnh.
- Ở trang Tiến độ học tập, nếu là Premium bạn sẽ thấy thêm dòng **"⭐ Premium
  đến [ngày]"** và **"🛡️ Thẻ bảo hiểm chuỗi: X/3"**.

### Đổi môn học khi là Free — "xem quảng cáo" để mở khoá

1. Bấm **"Đổi môn"** ở Trang cá nhân.
2. Nếu bạn là Free, màn hình **"Đổi môn học là quyền lợi Premium"** hiện ra.
3. Bấm **"🎬 Xem quảng cáo để đổi môn"** — đếm ngược 5 giây (đây là mô phỏng,
   chưa có quảng cáo thật).
4. Sau khi đếm ngược xong, hệ thống tự động mở khoá và chuyển bạn sang màn
   hình chọn môn học như bình thường.
5. Lượt mở khoá chỉ dùng được **1 lần** và hết hạn sau **5 phút** — nếu bạn
   để màn hình chọn môn quá lâu rồi mới bấm lưu, có thể cần xem lại quảng
   cáo lần nữa.

> Muốn đổi môn thoải mái không cần xem quảng cáo mỗi lần? Cân nhắc nâng cấp
> Premium.

### Ôn lại câu sai và Lịch sử thi thử — chỉ dành cho Premium

Nếu bạn là Free và bấm vào 2 tính năng này, thay vì dữ liệu, bạn sẽ thấy 1
banner giải thích đây là quyền lợi Premium. Đây không phải lỗi — tính năng
được thiết kế dành riêng cho Premium.

### Thẻ bảo hiểm chuỗi (Streak Freeze) — chỉ dành cho Premium

Nếu bạn là Premium, ngay khi kích hoạt bạn được cấp **3 thẻ bảo hiểm chuỗi**.
Nếu một ngày nào đó bạn **lỡ quên ôn tập đúng 1 ngày** (không phải 2 ngày trở
lên), hệ thống tự động dùng 1 thẻ để "bắc cầu" — streak của bạn **không bị
mất**, hoàn toàn tự động, không cần bạn làm gì.

- Xem số thẻ còn lại ở trang Tiến độ học tập: **"🛡️ Thẻ bảo hiểm chuỗi: X/3"**.
- Lỡ quên **2 ngày liên tiếp trở lên** vẫn làm mất streak, dù còn thẻ.
- Free không có thẻ nào — lỡ quên 1 ngày là mất streak ngay (giống trước đây).

### Câu hỏi thường gặp

**Q: Làm sao để trở thành Premium?**

A: Hiện tại Premium được admin cấp thủ công. Liên hệ admin/nhà trường để biết
thêm chi tiết về cách đăng ký/nâng cấp Premium.

**Q: Premium của tôi hết hạn thì sao?**

A: Bạn sẽ nhận thông báo 🔔 **"⏰ Premium sắp hết hạn"** trước 24 giờ. Sau khi
hết hạn, tài khoản tự động chuyển về Free (trừ khi công tắc "Mặc định Premium
cho tất cả" đang bật) — bạn không mất dữ liệu, chỉ mất quyền truy cập các
tính năng Premium cho tới khi được gia hạn.

**Q: Tôi được cấp thêm Premium khi đang còn hạn thì tính thế nào?**

A: Số tháng mới được **cộng dồn** vào hạn hiện tại (không tính lại từ hôm
nay). Ví dụ đang Premium tới 20/8, được cấp thêm 2 tháng → hạn mới là 20/10.

**Q: Tôi lỡ quên ôn tập 1 ngày nhưng streak vẫn còn — có phải lỗi không?**

A: Không phải lỗi — nếu bạn là Premium và còn thẻ bảo hiểm chuỗi, hệ thống tự
động "cứu" streak khi bạn lỡ đúng 1 ngày. Xem mục "Thẻ bảo hiểm chuỗi" ở trên.

**Q: Xem quảng cáo xong nhưng vẫn không đổi được môn?**
